...
# Import library DESeq2, ggplot2, gplots, RColorBrewer, pheatmap, BiocParallel.
library(DESeq2)
library(ggplot2)
library(gplots)
...
# The table contains values for each CDS included in the featurecount_data variable.
...
# Plotting Upregulated, Downregulated and Unchanged genes.
