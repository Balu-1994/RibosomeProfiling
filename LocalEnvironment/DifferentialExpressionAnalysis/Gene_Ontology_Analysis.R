...
# Import library grid, gridExtra, pathview, AnnotationDbi, clusterProfiler, topGO, ggplot2.
library(grid)
library(gridExtra)
library(pathview)
...
# Input the DESeq2 output file. Comprises a list of genes that have been upregulated, downregulated, and left unchanged.
